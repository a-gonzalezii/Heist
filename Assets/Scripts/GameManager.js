...
function Start () {
	...
	platform0.transform.position = new Vector3 (platform0.renderer.bounds.size.x/2, mainCamera.ScreenToWorldPoint(new Vector3(0f, Screen.height,0f)).y, 0f);
	platform1.transform.position = new Vector3 (platform1.renderer.bounds.size.x/2, mainCamera.ScreenToWorldPoint(new Vector3(0f, Screen.height/2,0f)).y+2, 0f); //+2
...
function Update () {//TODO: SETUP BOUNDS ON CAMERA
	...
	mainCamera.transform.position = new Vector3(xPos, mainCamera.transform.position.y, 0) + cameraOffset;
